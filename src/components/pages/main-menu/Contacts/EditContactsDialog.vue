    ...
    <q-card>
      ...
      <q-card-section class="q-mt-md justify-center content-center scroll">
        ...
        <q-input
            ...
            filled
            type="text"
            v-model="editItem.address_ru"
            :label="t(`${TRANC_PREFIX}.address_ru`)"
        />
        <q-input
            class="q-my-xs"
            filled
            type="text"
            v-model="editItem.address_uk"
            :label="t(`${TRANC_PREFIX}.address_uk`)"
        />
        <q-input
            class="q-my-xs"
            filled
            type="text"
            v-model="editItem.address_en"
            :label="t(`${TRANC_PREFIX}.address_en`)"
        />
        <q-input
            class="q-my-xs"
            filled
            type="text"
            v-model="editItem.address_ge"
            :label="t(`${TRANC_PREFIX}.address_ge`)"
        />
      </q-card-section>

...
const {closeAddDialog,saveAddItem} = newsStore
const {addDialog,previewImg,addItem} = storeToRefs(newsStore)
...
const disableSubmit = computed(() => {
  return !addItem.value.imagePath || !addItem.value.date
})
</script>
      ...
      <q-card-section class="q-mt-md justify-center content-center scroll">
        ...
        >
          <q-tab-panel v-for="tabPanel in tabs" :name="tabPanel">
            ...
            <div v-show="tabPanel !== BASE_SETTING">
              <q-input filled v-model="addItem['name_'+tabPanel]" :label="t(`${TRANC_PREFIX}.name`)"/>
              <MyQuillEditor
                  class="q-my-xs"
                  ...
                  v-model:model="addItem['short_content_'+tabPanel]"/>
              <MyQuillEditor
                  class="q-my-xs"
                  ...
                  v-model:model="addItem['content_'+tabPanel]"/>
            </div>
          </q-tab-panel>
        </q-tab-panels>
      </q-card-section>
